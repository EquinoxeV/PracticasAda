...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#938b56c5#;
   ...
   u00146 : constant Version_32 := 16#da258d18#;
   ...
   u00159 : constant Version_32 := 16#4f1232e6#;
   pragma Export (C, u00159, "ioB");
   u00160 : constant Version_32 := 16#9f7a8717#;
   pragma Export (C, u00160, "ioS");
   u00161 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00161, "ada__integer_text_ioB");
   u00162 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00162, "ada__integer_text_ioS");
   u00163 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00163, "system__img_biuS");
   u00164 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00164, "system__img_llbS");
   u00165 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00165, "system__img_lliS");
   u00166 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00166, "system__img_lllbS");
   u00167 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00167, "system__img_llliS");
   u00168 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00168, "system__img_lllwS");
   u00169 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00169, "system__img_llwS");
   u00170 : constant Version_32 := 16#08fa6212#;
   ...
   u00173 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00173, "system__val_llliS");
   u00174 : constant Version_32 := 16#f82486d6#;
   ...
   u00177 : constant Version_32 := 16#4cf0c4b7#;
   pragma Export (C, u00177, "juegoB");
   u00178 : constant Version_32 := 16#9d74c3fe#;
   pragma Export (C, u00178, "juegoS");
   u00179 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00179, "system__concat_2B");
   u00180 : constant Version_32 := 16#2d5a86c4#;
   pragma Export (C, u00180, "system__concat_2S");
   u00181 : constant Version_32 := 16#46b1f5ea#;
   pragma Export (C, u00181, "system__concat_8B");
   u00182 : constant Version_32 := 16#ccfd1cc3#;
   pragma Export (C, u00182, "system__concat_8S");
   u00183 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00183, "system__concat_7B");
   u00184 : constant Version_32 := 16#d33d0a0b#;
   pragma Export (C, u00184, "system__concat_7S");
   u00185 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00185, "system__concat_6B");
   u00186 : constant Version_32 := 16#fd3d7ca6#;
   pragma Export (C, u00186, "system__concat_6S");
   u00187 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00187, "system__concat_5B");
   u00188 : constant Version_32 := 16#a8a4123a#;
   ...
   u00192 : constant Version_32 := 16#248a0db1#;
   pragma Export (C, u00192, "system__concat_3S");
   u00193 : constant Version_32 := 16#ca8c282d#;
   pragma Export (C, u00193, "system__finalization_mastersB");
   u00194 : constant Version_32 := 16#4e386d0b#;
   pragma Export (C, u00194, "system__finalization_mastersS");
   u00195 : constant Version_32 := 16#35d6ef80#;
   pragma Export (C, u00195, "system__storage_poolsB");
   u00196 : constant Version_32 := 16#548cb6a3#;
   pragma Export (C, u00196, "system__storage_poolsS");
   u00197 : constant Version_32 := 16#071824fe#;
   pragma Export (C, u00197, "system__val_enum_8S");
